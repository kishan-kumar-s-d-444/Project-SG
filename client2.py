...
def download_update_file(client, filename, version='1'):
    ...
    save_path = os.path.join('downloads', f'client2_{filename}_verified')
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Client2 operations')
    parser.add_argument('operation', type=int, choices=[1, 2], 
                      help='1: Get telemetry data, 2: Download file')
    parser.add_argument('--filename', type=str, default='client2_latest_update',
