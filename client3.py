...
def download_update_file(client, filename, version='1'):
    ...
    save_path = os.path.join('downloads', f'client3_{filename}_verified')
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Client3 operations')
    parser.add_argument('operation', type=int, choices=[1, 2], 
                      help='1: Get telemetry data, 2: Download file')
    parser.add_argument('--filename', type=str, default='client3_latest_update',
