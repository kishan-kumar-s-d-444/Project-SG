...
def download_update_file(client, filename, version='1'):
    ...
    save_path = os.path.join('downloads', f'client1_{filename}_verified')
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Client1 operations')
    parser.add_argument('operation', type=int, choices=[1, 2], 
                      help='1: Get telemetry data, 2: Download file')
    parser.add_argument('--filename', type=str, default='client1_latest_update',
